...
## Expressive tables with `kableExtra` 
...
And then include citations in the text with the format **`[@CitationKey]`**, which in the shown entry was for example **`[@XieAllaire_et_2022]`**, which is a reference to [@XieAllaire_et_2022]. 

Add the header `# References` at the end of your document, `knit`and you get: pure magic!
  </div>
</div>
...
## Switch citation styles dynamically
